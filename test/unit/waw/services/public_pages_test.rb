...
module Waw
  module Services
    class PublicPagesTest < Test::Unit::TestCase
      include Waw::Services::PublicPages::Utils
      ...
      def setup
        ...
        @controller = Waw::Services::PublicPages.new(Waw::Services::PublicPages::DEFAULT_OPTIONS.merge(:templates_folder => public_pages, :pages_folder => public_pages))
      end
